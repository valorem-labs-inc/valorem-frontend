  ...
  return (
    <Wrapper>
      ...
      <div className="warning">
        ...
        <p>
          Failed to connect to Rinkeby network with MetaMask wallet. Please try
          again.
        </p>
      </div>
      <div className="step">
        ...
        <div className="options">
          <Option>
            <img alt="" className="selected-indicator" src="/check-icon.svg" />
            <div className="icon">
              <img alt="MetaMask logo" src="/metamask.svg" />
            </div>
            <span>MetaMask</span>
          </Option>
          <Option>
            ...
            <div className="icon">
              <img alt="WalletConnect logo" src="/wallet-connect.svg" />
            </div>
      ...
      <div>
        <Button theme="purple-blue">Launch</Button>
      </div>
    </Wrapper>
  );
};
